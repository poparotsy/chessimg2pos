#!/usr/bin/env python3
"""
🐉 KAGGLE BEAST - Maximum GPU Utilization
- Batch size 4096 (saturates dual T4 GPUs)
- Mixed precision (AMP) + gradient scaling
- Focal Loss + Label Smoothing
- Real-time logging with progress bars
...
output_model = os.path.join(base_dir, "models", "model_beast.pt")
checkpoint_path = os.path.join(base_dir, "models", "checkpoint_beast.pt")
...
print("="*70)
print("🐉 KAGGLE BEAST MODE - Maximum GPU Utilization")
print("="*70)
...
for epoch in range(start_epoch, EPOCHS):
    ...
    print(f"   LR: {optimizer.param_groups[0]['lr']:.6f} | GPU: {get_gpu_mem()}")
